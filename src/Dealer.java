	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			case 3 :
				if(user1Card == 0 && shareCount == 0) {
					System.out.println("\n[아직 카드를 받지 않았습니다.]\n");
				} else if(user1Card == 0 && shareCount == 10 && selectCount == 0) {
					System.out.println("\n[아직 카드를 선택하지 않았습니다.]\n");
				} else if(user1Card != 0 && shareCount == 10 && selectCount == 1 && openCount == 0) {
			...
			case 4 :
				if(user1Card == 0 && shareCount == 0) {
					...
					System.out.println("\n[아직 카드를 공개하지 않았습니다.]\n");
				} else if(user1Card != 0 && shareCount == 10 && selectCount == 1 && openCount == 1 && dualCount == 0) {
			...
			case 5 :
				if(user1Card == 0 && shareCount == 0) {
					...
					System.out.println("\n[아직 카드를 공개하지 않았습니다.]\n");
				} else if(user1Card != 0 && shareCount == 10 && selectCount == 1 && openCount == 1 && dualCount == 1) {
					System.out.println("\n[이미 승부를 겨루었습니다.]\n");
				} else if(user1Card != 0 && shareCount == 10 && selectCount == 1 && openCount == 1 && dieCount == 0) {
